...
def _prepare(data_dir):
    ...
    image_files = get_image_names_from_dir(get_raw_dir(data_dir))
    ...
    print("downsampling...")
    downsample_images(pool, data_dir, image_files)
    print("downsampling done")
    """

    print("generating default masks...")
    generate_default_masks(pool, data_dir, image_files)
    print("done")

    print("segmenting images...")
    segment_images(pool, data_dir, image_files)
    print("segmenting done")

    print("splitting parts...")
    split_parts(pool, data_dir, image_files)
    print("splitting parts done")
    """
